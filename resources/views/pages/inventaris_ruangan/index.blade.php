                    ...
                    <form action="{{ route('inventaris-ruangan.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Kode Barang (Opsional)</label>
                                    <input type="text" name="kode_barang" class="form-control" placeholder="Contoh: 3050204004 (10 digit)">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">NUP (Opsional)</label>
                                    <input type="text" name="nup" class="form-control" placeholder="Contoh: 1 s.d 24 / NUP spesifik">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label fw-bold">Nama Barang <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_barang" class="form-control" placeholder="Contoh: P.C Unit (Hp Pavilion) / Kursi Besi" required>
                                </div>
                                <div class="col-md-8">
                                    <label class="form-label fw-bold">Spesifikasi / Merk Tipe</label>
                                    <input type="text" name="spesifikasi_merk_tipe" class="form-control" placeholder="Contoh: HP / Panasonic / Malvin 800M">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">Tahun Perolehan</label>
                                    <input type="number" name="tahun_perolehan" class="form-control" placeholder="Contoh: 2020" min="1900" max="2100" value="{{ date('Y') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">Jumlah <span class="text-danger">*</span></label>
